...
Server.command.register(registerInformationH, (data, args) => {
    if(!Server.player.find(data.sender.name)) return null;
    const cmdInfo = Server.command.getRegistration(args[0]);
    var cmdList = Server.command.get();
    if(cmdInfo) {
        if(cmdInfo && cmdInfo.private) return Server.eBroadcast('I couldn\'t find the command...',data.sender.name, 'HELP');
        if(cmdInfo && cmdInfo.admin==true && !Server.player.isAdmin(data.sender.name)) Server.eBroadcast(Lang.noT,data.sender.name);
        let hI: string = `§l§cCommand: §l§5${Server.CP}§l§4${cmdInfo.name}§r\n`;
        ...
        if(cmdInfo.category) hI += `§l§cCategory§5: ${cmdInfo.category}§c§r\n`;
...
Server.command.register(registerInformationC, (chatmsg) => {
    ...
    if(!Server.player.isAdmin==false) return Server.eBroadcast(Lang.error, chatmsg.sender.name, 'ROT');
    Server.close();
});
...
if(!CHAT_LOGGER.has("pages")) CHAT_LOGGER.set('pages','1');
if(!CONFIG.has('rot_id')) CONFIG.set('rot_id',Math.floor(Math.random() * 1525000000).toString())
if(!CONFIG.has('chatlogger')) CONFIG.set('chatlogger','0')
Server.command.register({
    ...
    if(!args[0]) return Server.runCommands([`playsound random.glass @a[name="${chatmsg.sender.name}"]`,`tellraw @a[name="${chatmsg.sender.name}"] {"rawtext":[{"text":" \u00a7\u0063\u0059\u006f\u0075\u0072 \u0063\u006f\u006d\u006d\u0061\u006e\u0064 \u0070\u0072\u0065\u0066\u0069\u0078 \u0063\u0061\u006e\u006e\u006f\u0074 \u0062\u0065 \u006e\u006f\u0074\u0068\u0069\u006e\u0067\u002e"}]}`]);
    if(args[0].startsWith('/')) return Server.runCommands([`playsound random.glass @a[name="${chatmsg.sender.name}"]`,`tellraw @a[name="${chatmsg.sender.name}"] {"rawtext":[{"text":" \u00a7\u0063\u0050\u006c\u0065\u0061\u0073\u0065 \u0064\u006f \u004e\u004f\u0054 \u0075\u0073\u0065 \u0061\u006e\u0079\u0074\u0068\u0069\u006e\u0067 \u0074\u0068\u0061\u0074 \u0073\u0074\u0061\u0072\u0074\u0073 \u0077\u0069\u0074\u0068 \u005c\u0022\u002f\u005c\u0022! \u0049\u0074\u0027\u006c\u006c \u0062\u0072\u0065\u0061\u006b \u0052\u004f\u0054 \u0061\u006e\u0064 \u006d\u0061\u006b\u0065 \u0069\u0074 \u0075\u006e\u0075\u0073\u0061\u0062\u006c\u0065 \u0077\u0069\u0074\u0068\u006f\u0075\u0074 \u0063\u006f\u006d\u0070\u006c\u0065\u0074\u0065\u006c\u0079 \u0064\u0065\u006c\u0065\u0074\u0069\u006e\u0067 \u0061\u006c\u006c \u0064\u0061\u0074\u0061\u0062\u0061\u0073\u0065 \u0064\u0061\u0074\u0061\u002e"}]}`]);
...
Server.command.register({
    ...
    if (!Server.player.findTag('rot', chatmsg.sender.name)) return Server.runCommands([`playsound random.glass @a[name="${chatmsg.sender.name}"]`,`tellraw @a[name="${chatmsg.sender.name}"] {"rawtext":[{"text":"${Lang.setupa}"}]}`]);
    if (!Server.player.findTag('t', chatmsg.sender.name)) return Server.runCommands([`playsound random.glass @a[name="${chatmsg.sender.name}"]`,`tellraw @a[name="${chatmsg.sender.name}"] {"rawtext":[{"text":"${Lang.error}"}]}`]);
    if(CONFIG.get('chatlogger') == 0) return Server.runCommands([`playsound random.glass @a[name="${chatmsg.sender.name}"]`, `tellraw @a[name="${chatmsg.sender.name}",tag=!v] {"rawtext":[{"text":"${Lang.CMDnotOna1}${CMDTname2}${Lang.CMDnotOna2}"}]}`,`tellraw @a[name="${chatmsg.sender.name}",tag=v] {"rawtext":[{"text":"${Lang.CMDnotOnb1}${CMDTname2}${Lang.CMDnotOnb2}${CMDTname2}${Lang.CMDnotOnb3}"}]}`]);
    if(CHAT_LOGGER.get('messages') == '0' && CHAT_LOGGER.get('pages') == '1') return;
